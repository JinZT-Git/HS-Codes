...
class MobileNetV2(nn.Module):
    ...
    def _load_pretrained_model(self):
        ...
        pretrain_dict = model_zoo.load_url('http://jeff95.me/models/mobilenet_v2-6a65762b.pth', model_dir=model_path)
        print("Load pretrain weights from http://jeff95.me/models/mobilenet_v2-6a65762b.pth")
        model_dict = {}
