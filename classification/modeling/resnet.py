...
def resnet18(pretrained=False, **kwargs):
    """Constructs a ResNet-18 weights.

    Args:
        pretrained (bool): If True, returns a weights pre-trained on ImageNet
    """
    ...
    if pretrained:
        pretrained_dict = model_zoo.load_url(model_urls['resnet18'],
                                             model_dir=model_path)  # Modify 'model_dir' according to your own path
        print('Petrain resnet18 Model Have been loaded!')
...
def resnet34(pretrained=False, **kwargs):
    """Constructs a ResNet-34 weights.
...
def resnet50(pretrained=False, **kwargs):
    """Constructs a ResNet-50 weights.
...
def resnet101(pretrained=True, **kwargs):
    """Constructs a ResNet-101 weights.
...
def resnet152(pretrained=False, **kwargs):
    """Constructs a ResNet-152 weights.
