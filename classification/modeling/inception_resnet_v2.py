...
from modeling.units import Conv2d, Reduction_A
...
def My_In_Res_V2():
	...
	path = r'E:\2.Pythonfile\Hisense\code\oneNet_file\pre_train\inceptionresnetv2.pth'
	model.load_state_dict(torch.load(path))
	print("--->> Loaded the weights of Inceptionv4 from ", path)
	return model
